...
const ContractForm = ({ mode, contractId, initialData }: ContractFormProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(
                    err?.message ||
                    `Failed to ${mode === "create" ? "create" : "update"} contract`
                );
            }
            ...
            setSuccessMessage(
                mode === "create"
                    ? "Contract created successfully! You will be rerouted shortly."
                    : "Contract updated successfully! You will be rerouted shortly."
            );
        ...
        <div className="flex flex-col items-center">
            ...
            >
                ...
                <div className="m-3 flex flex-row gap-4">
                    ...
                    >
                        {mode === "create" ? "Submit" : "Update Contract"}
                    </button>
                    <button
