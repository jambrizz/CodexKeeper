...
export const clientSchema = z.object({
    ...
    MiddleName: z.string().nullable(), // Allows null values
    LastName: z.string().min(1, "Last Name is required"),
    DOB: z
        .string()
        .min(10, "Date of birth needs to be formatted as MM/DD/YYYY")
        .max(10, "Date of birth needs to be formatted as MM/DD/YYYY"),
